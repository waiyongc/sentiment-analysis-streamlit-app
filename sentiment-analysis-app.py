...
TFIDF_vectorizer=pickle.load(open(r'sentiment-analysis-streamlit-app/latest_vectorizer.pk','rb'))
loaded_model=joblib.load(open(r'sentiment-analysis-streamlit-app/latest_XGB_Model.pkl','rb'))
