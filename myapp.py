...
st.set_page_config(page_title="ChoiWaiYong_FYP",layout="wide")

loaded_model=joblib.load(open(r"C:\\Users\\Choi Wai Yong\\Documents\\Year3Sem2\\FYP\\latest_XGB_Model.pkl","rb"))
TFIDF_vectorizer=pickle.load(open(r"C:\\Users\\Choi Wai Yong\\Documents\\Year3Sem2\\FYP\\latest_vectorizer.pk","rb"))
